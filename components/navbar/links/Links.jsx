  ...
  return (
    <div className={`navbar-items flex flex-row lg:flex-row mt-32 mb-10 lg:my-0 ${containerClass}`}>
      {links.map((link) => (
        ...
        >
          <div 
            className={`relative flex items-center justify-center w-10 h-10 rounded-full ${BlackWhite ? 'bg-white' : 'bg-gradient-to-b from-[#FC7668] to-[#EB553A] shadow-inner shadow-custom-inset'} overflow-hidden`} 
          >
